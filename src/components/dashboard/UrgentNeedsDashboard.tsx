...
interface UrgentNeedsDashboardProps {
  userLocation: string;
  isReadOnly?: boolean;
}
...
export const UrgentNeedsDashboard = ({ userLocation, isReadOnly = false }: UrgentNeedsDashboardProps) => {
    ...
    <div className="bg-white rounded-lg shadow-md p-4">
      ...
      {loading ? (
        ...
        <div className="text-center py-6 text-gray-500">
          ...
          <p className="text-sm">No urgent needs</p>
        </div>
      ) : (
          ...
          {needs.map((need) => (
            ...
            >
              ...
              <button
                ...
                title={isReadOnly ? 'Complete registration to sign up' : ''}
              >
                Sign up
              </button>
            </div>
